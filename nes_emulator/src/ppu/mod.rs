...
use instr_reg::addr::AddrRegister;
use instr_reg::control::ControlRegister;
use instr_reg::mask::MaskRegister;
use instr_reg::scroll::ScrollRegister;
use instr_reg::status::StatusRegister;
